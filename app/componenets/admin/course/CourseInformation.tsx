            ...
            <form onSubmit={handleSubmit} className={`${styles.label}`}>
                    ...
                    >
                        {
                            courseInfo.thumbnail ? (
                                <img src={courseInfo.thumbnail} alt="thumbnail" className=" max-h w-full object-cover"/>
                            ) : (
                ...
                <div className="w-full flex items-center justify-end">
                    <input
                        type="submit"
                        value="Next"
                        className="w-full 800px:w-[180px] h-[40px] bg-[#37a391] text-center text-white rounded mt-8 cursor-pointer"
                    />
                </div>
                <br/><br/>
            </form>
